import{j as e,u as m}from"./index-D7i6mPfY.js";import{N as h}from"./NewsletterForm-92skor_4.js";const t=({title:i,description:a,category:s,readTime:o,date:d,image:l,link:r,featured:c=!1})=>{const p=u=>{switch(u.toLowerCase()){case"product updates":return"#3b82f6";case"crm":return"#8b5cf6";case"sales & marketing":return"#10b981";case"product support":return"#f59e0b";case"grants":return"#ff5656ff";default:return"#6b7280"}};return e.jsxs("article",{className:`blog-card ${c?"featured":""}`,children:[e.jsx("div",{className:"blog-card-image",children:e.jsxs("a",{href:r,children:[e.jsx("img",{src:l,alt:i,loading:"lazy"}),e.jsx("div",{className:"blog-card-overlay",children:e.jsx("span",{className:"category-badge",style:{backgroundColor:p(s)},children:s})})]})}),e.jsxs("div",{className:"blog-card-content",children:[e.jsx("h3",{className:"blog-card-title",children:e.jsx("a",{href:r,children:i})}),e.jsx("p",{className:"blog-card-description",children:a}),e.jsxs("div",{className:"blog-card-meta",children:[e.jsx("span",{className:"blog-card-date",children:d}),e.jsx("span",{className:"blog-card-divider",children:"•"}),e.jsx("span",{className:"blog-card-read-time",children:o})]}),e.jsxs("a",{href:r,className:"blog-card-link",children:["Read More",e.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2","aria-labelledby":"readMoreArrowTitle",children:[e.jsx("title",{id:"readMoreArrowTitle",children:"→"}),e.jsx("path",{d:"M5 12h14M12 5l7 7-7 7"})]})]})]}),e.jsx("style",{children:`
                .blog-card {
                    background: white;
                    border-radius: 1rem;
                    overflow: hidden;
